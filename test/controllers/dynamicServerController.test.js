const { getAllPhones, postPhone } = require('../../controllers/dynamicServerController'); // Ensure this file exists and path is correct
const { MongoClient } = require('mongodb');
jest.mock('mongodb');

describe('Dynamic Server Controller', () => {
    let req, res;
